  ...
  <section class="section-padding reservation-top-section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 col-xs-12">
           <h2 class="text-left">Event dan Sponsorship</h2>
  ...
  <!--==| Events Content Start|==-->
	<div class="container">
        <div class="categories archive">
            <h3 class="h3">Kontak Humas: </h3>
            <ul class="list-unstyled">
            <li><i class="fa fa-phone-square"></i> Telpon: <a href="tel:6281391515363">081391515363</a></li>
            <li><i class="fa fa-phone-square"></i> email: <a href="#" rel="nofollow" onclick="this.href='mailto:' + 'humaswaroengss' + '@' + 'gmail.com'">humaswaroengss@gmail.com</a></li>
            </ul>
        </div>
	</div>
