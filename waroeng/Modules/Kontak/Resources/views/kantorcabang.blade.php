  ...
  <section class="section-padding reservation-top-section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 col-xs-12">
           <h2 class="text-left">Kantor Cabang</h2>
        <p class="slogan">Bagaimana cara menghubungi</p>
  ...
  <!--==| Events Content Start|==-->
	<div class="container">
        <div class="categories archive">
            ...
            <li><i class="fa fa-phone-square"></i> Kantor Pusat Yogyakarta: <a href="#">081391515363</a></li>
            <li><i class="fa fa-phone-square"></i> Kantor Cabang Yogyakarta: <a href="#">081391515363</a></li>
            <li><i class="fa fa-phone-square"></i> Kantor Cabang Jabotabek: <a href="#">081391515363</a></li>
            <li><i class="fa fa-phone-square"></i> Kantor Cabang Purwokerto: <a href="#">081391515363</a></li>
            <li><i class="fa fa-phone-square"></i> Kantor Cabang Semarang: <a href="#">081391515363</a></li>
            <li><i class="fa fa-phone-square"></i> Kantor Cabang Solo: <a href="#">081391515363</a></li>
            <li><i class="fa fa-phone-square"></i> Kantor Cabang Malang: <a href="#">081391515363</a></li>
            <li><i class="fa fa-phone-square"></i> Kantor Cabang Bali: <a href="#">081391515363</a></li>
            </ul>
        </div>
        <div class="categories archive">
                <h3 class="h3">Kontak Malaysia: </h3>
                <ul class="list-unstyled">
                <li><i class="fa fa-phone-square"></i> Kantor Cabang Kuala Lumpur: <a href="#">081391515363</a></li>
                </ul>
            </div>
	</div>
